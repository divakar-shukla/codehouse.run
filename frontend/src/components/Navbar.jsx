  ...
  return (
    <nav className="fixed w-full z-50 transition-all duration-300 backdrop-blur-sm top-0 left-0 mt-2">
      <div className="w-full d-flex justify-center">
        <div
          className={`transition-all duration-700 transform-gpu mx-auto border ${
            scrolled
              ? "scale-x-100  backdrop-blur-sm shadow-lg"
              : "scale-x-100 rounded-2xl  backdrop-blur-md shadow-xl"
          }`}
          style={{
          ...
          <div className="px-6 lg:px-8">
            <div className="flex items-center justify-between">
              <div>
                <Link
                  to={"/"}
                  className="flex items-center text-[var(--foreground)] transition-colors"
                >
                  <span className="font-bold text-xl">
                    {/* <img
                      src="http://localhost:5173/matecia-logo-3.png"
                      alt=""
                      className="w-25"
                    /> */}
                    CodeHouse.run
              ...
              <div>
                <ul className="flex gap-7 text-lg  text-[var(--primary)]">
                  <li className="px-7 cursor-pointer">
