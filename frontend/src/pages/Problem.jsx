        ...
        <div className='w-full p-2'> 
            ...
            <div className='grid grid-cols-1 md:grid-cols-3 gap-4 mt-8 bg-[var(--card)] py-6 px-4 rounded-sm'>
                <div className='flex items-center bg-[var(--primary)] rounded'>
                    <input type="text" className='py-2 px-4 rounded hover:outline-0 focus:outline-0 w-full placeholder:text-[var(--background)]' placeholder='Search Problem'/>
                </div>
                <div className='flex items-center bg-[var(--primary)] rounded '>
             ...
             <table className='border w-full p-6 table-auto min-w-[700px]' >
                ...
                <tbody className='bg-[var(--background)] text-sm'>
                    <tr className='border-b-2'>
                        ...
                        <th className='px-2 py-3 text-left'>Add Two Numbers</th>
                        ...
                        <th className='px-2 py-3 text-left'><Circle /></th>
                        <th className='px-2 py-3 text-left'><Circle /></th>
                    </tr>
                    <tr className='border-b-2'>
                        <th className='px-2 py-3  text-left'><Circle className='size-4 text-[var(--detail-font-color)]'/></th>
